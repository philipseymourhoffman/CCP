...
(function() {
    ...
    const targetUsers1 = ['PhilipSeymourHoffman'];
    ...
    const targetUsers2 = ['GroyperGosling', 'Exousia'];
    // Customize the color changing the hexcode to your preferred color
    ...
    const targetUsers3 = ['Kimahri_Ronso', 'DannyPhantom', 'BigBongoTheRealFren', 'michael'];
